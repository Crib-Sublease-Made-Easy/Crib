        ...
        <Header>
            ...
            elevation: 5, borderRadius: 20, shadowOffset: {width: 0, height: 0}}} >
                    <SearchInputCancelIconContainer>
                        <PlaceholderLogoTextContainer placeholder="Looking at ..." value={locationQuery}  onChangeText={(value)=>autocomplete(value)} 
                        onEndEditing={()=>{closeHeader(), setSearching(false), setautocompleteLocation([]), Keyboard.dismiss()}} onFocus={()=> {openHeader(),setSearching(true), autocomplete(locationQuery), setPropertyPreviewCard(false)}}/>
