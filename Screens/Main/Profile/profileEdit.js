...
export default function ProfileEditScreen({ navigation, route }) {
    ...
    const [pronouns, setPronouns] = useState(route.params.userData == undefined ? null : route.params.userData.pronouns)
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
            <ScrollView>
                ...
                <RowContainer onPress={() => navigation.navigate("EditPronouns")}>
                    <RowName>{pronouns}</RowName>
